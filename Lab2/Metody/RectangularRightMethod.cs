internal class RectangularRightMethod : IMethod
{
    public string Name => "Rectangular (right) Method";
            ...
            () =>
            {
                Parallel.For(0, Environment.ProcessorCount, i =>
                {
                    ...
                    Parallel.For(chunkStart, chunkEnd, new ParallelOptions { CancellationToken = token }, j =>
                    {
                        ...
                        double localResult = function.GetY(next) * stepSize; // Liczenie prostokątne
